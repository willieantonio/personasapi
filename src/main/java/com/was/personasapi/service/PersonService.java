...
import com.was.personasapi.exception.PersonNotFoundException;
...
public class PersonService {
    ...
    public MessageResponseDTO create(PersonDTO personDTO){
        ...
        return createMessageResponse("Person successfully created whit ID ", savedPerson.getId());
    }
    ...
    public MessageResponseDTO update(Long id, PersonDTO personDTO) throws  PersonNotFoundException{
        ...
        return createMessageResponse("Person successfully update with ID ", savedPerson.getId());
    }
